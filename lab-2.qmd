...
The percentage variable is mapped to color. Country is mapped to the tiles.

10. What type of graph would you call this?

I would call this graph a map.

11. List all of the problems or things you would improve about this graph.

- I would improve the graph's functionality. I know this is a still graph, but I would want to be
...
- I think I would use a different palette that has two colors on each end of the scale, rather than
just using different shades of green.
